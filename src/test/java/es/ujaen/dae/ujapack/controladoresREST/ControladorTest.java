...
//        ResponseEntity<DTOPaquete> respuestaEnvio = restTemplateUsuario.getForEntity("/paquetes/{localizador}", DTOPaquete.class, PaqueteCreado.getLocalizador());
//        Assertions.assertThat(respuestaEnvio.getStatusCode()).isEqualTo(HttpStatus.OK);
//        Assertions.assertThat(paq.getEstado().equals(PaqueteCreado.getEstado()));
//
////        serviPack.notificarSalida(paq.getLocalizador(), LocalDateTime.now(), paq.getRuta().get(1).getId());
////        serviPack.notificarEntrada(paquet.getLocalizador(), LocalDateTime.now(), paq.getRuta().get(1).getId());
////        Assertions.assertThat(paq.getEstado().equals(Paquete.Estado.EnTransito));
//
//        
//        
//    }
